...
public class UserController {
	...
	// ajax /user/userSearchList
	@RequestMapping(value="/user/userSearchList",method = RequestMethod.POST)
	public @ResponseBody List<UserDTO> userSearchList(HttpServletRequest request) throws Exception {
		...
		List<UserDTO> uList = userService.getUserList(uDTO);
