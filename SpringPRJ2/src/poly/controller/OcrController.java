...
public class OcrController {
	...
	/*
	 * 비즈니스 로직(중요 로직을 수행하기 위해 사용되는 서비스를 메모리에 적재(싱글패턴)
	 */
	...
	public String getReadForImageText(HttpServletRequest request, HttpServletResponse response, ModelMap model,
		...
		if (ext.equals("jpeg") || ext.equals("jpg") || ext.equals("gif") || ext.equals("png")) {
			...
			log.info("org_file_name : " + org_file_name);
			...
			pDTO.setOcr_text(rDTO.getOcr_text()); // 저장된 이미지로부터 읽은 글씨
