...
public class MelonController {
    ...
    @ResponseBody
    public String collectMelonRankUsingDTO() throws Exception {
    ...
    @ResponseBody
    public List<MelonDTO> getSongListUsingDTO() throws Exception {
    ...
    @ResponseBody
    public List<MelonDTO> getSingerSongCntUsingDTO() throws Exception {
